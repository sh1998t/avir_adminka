...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, ErrorModel? error, bool isLoginSuccess});
}
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl(
      {this.isLoading = false, this.error, this.isLoginSuccess = false});
  ...
  @override
  String toString() {
    return 'AuthState(isLoading: $isLoading, error: $error, isLoginSuccess: $isLoginSuccess)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoading, error, isLoginSuccess);
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      {final bool isLoading,
      final ErrorModel? error,
      final bool isLoginSuccess}) = _$AuthStateImpl;
