...
class PdfService {
  Future<void> printCustomersPdf(InvoiceResponse data) async {
    ...
    final image2 = await imageFromAssetBundle('assets/images/image2.png');
                    ...
                    children: [
                      ...
                      pw.Row(children: [
                                    ...
                                    pw.Container(
                                      ...
                                      child: pw.Row(children: [
                                        ...
                                        pw.Container(
                                          ...
                                          child: pw.Center(
                                            child: pw.Text(
                                              FormatText().moneyFormat(data
                                                      .data?.invoiceDUK?.amount
                                                      .toString() ??
                                                  ""),
                                              style: pw.TextStyle(
                                                  font: font,
                        ...
                        pw.Container(
                          ...
                          height: 60,
                          child: pw.Center(
                            child: pw.Image(image2, width: 60, height: 50),
                          ),
                        ),
                      ]),
                    ...
                    children: [
                      ...
                      pw.Row(children: [
                        ...
                        pw.Container(
                          width: 180,
                          child: pw.Text(
                            data.data?.invoiceIDCard?.budgetAccount
                                    .toString() ??
                                "",
                            style: pw.TextStyle(font: font),
                          ),
                      ...
                      pw.Row(children: [
                        ...
                        pw.Container(
                          width: 140,
                          child: pw.Text(
                            data.data?.invoiceIDCard?.treasuryAccount
                                    .toString() ??
                                "",
                            style: pw.TextStyle(font: font),
                          ),
                      ...
                      pw.Row(
                          ...
                          children: [
                            ...
                            pw.Container(
                              ...
                              height: 60,
                              child: pw.Center(
                                child: pw.Image(image, width: 60, height: 50),
                              ),
                            ),
                          ]),
                      pw.SizedBox(
